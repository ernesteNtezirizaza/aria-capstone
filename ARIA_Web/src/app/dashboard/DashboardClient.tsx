...
import { Activity, Target, AlertTriangle, Sprout, ArrowLeft, Database } from 'lucide-react';
import Link from 'next/link';

export default function DashboardClient({ episodes, stats }: { episodes: any[], stats: any }) {
